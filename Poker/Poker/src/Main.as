package
{
	...
	{
		public static const UPDATE_DELAY:int = 750;
		...
		{			
			...
			var players:Array = [	new Hal("Hal", PokerTable.PLAYER_INIT_STACK),
									new PokerPlayer("Dave", PokerTable.PLAYER_INIT_STACK),
									new PokerPlayer("Frank", PokerTable.PLAYER_INIT_STACK),
									new PokerPlayer("Heywood", PokerTable.PLAYER_INIT_STACK)
								];
